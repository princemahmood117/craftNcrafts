  ...
  try {
    ...
    // এখন http://localhost:5000/coffee তে সব গুলো ডাটা শো করবে array  হিসাবে
        ...
        app.post('/crafts', async(req,res)=>{
            const newCrafts = req.body; // from (A) : '/coffee' থেকে যেই ডাটা গুলা আসবে সেগুলা req এর মধ্যে body তে করে আসবে| যেহেতু ডাটা গুলা এসে সার্ভারে এড হবে,তাই এখানে মেথদ হবে app.post()। সেখান থেকে ডাটাবেইজে পাঠানো হবে
